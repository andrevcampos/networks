...
function member_upload_logo_endpoint() {
    register_rest_route('networkers/v1', '/member/upload-logo', array(
        'methods' => 'GET',
        'callback' => 'member_upload_logo_callback',
    ));
}

function member_upload_logo_callback($request) {

    include '../../../../wp-load.php';

    $post_id = $request->get_param('postid');
    $logoid = $request->get_param('logoid');
...
add_action('rest_api_init', 'member_upload_logo_endpoint');
