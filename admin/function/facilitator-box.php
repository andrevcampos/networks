        ...
        echo '<div style="position:relative">';
            ...
            echo '<div class="hideinputfacilitator" style="display:block">';
                foreach($members as $post) {
                    $member = Get_Member($post);
                    $fullname = $member->firstname . " " . $member->lastname;
                    $onclick = "addfacilitator(\"$member->ID\",\"$fullname\", " . ($multiple ? 'true' : 'false') . ")";
        ...
        echo '<div id="facilitators">';
            if($facilitatorselectedd != ""){
                ...
                echo '<div class="facilitatordiv" style="width:100%;max-width:500px;display:flex">';
                    ...
                    echo "<input class='inputfacilitator' type='text' value='$member->firstname $member->lastname' name='facilitator[]' style='width:calc(100% - 50px);border-top-right-radius:0px;border-bottom-right-radius:0px;' readonly>";
