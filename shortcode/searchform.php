...
function search_form() {
    ...
    <form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
        ...
        <label>
            ...
            <input type="search" class="search-field" placeholder="<?php echo esc_attr_x('Search …', 'placeholder', 'your-theme-text-domain'); ?>" value="<?php echo get_search_query(); ?>" name="s" style="height: 40px; background-color: #f1f2f3; border: none;" />
        </label>

        <!-- Icon for the search button (using Font Awesome as an example) -->
        <button type="submit" class="search-submit">
            <i class="fas fa-search" style="color:#8d9093"></i> <!-- Replace this with the actual icon code or image -->
        </button>
    </form>
    <?php
    return ob_get_clean();
